\def\datasetsandexperiments{
    ...
    \begin{figure}[H]
        ...
        \subfigure[]{\includegraphics[width=10cm]{images/widerface_highres_3}}
        \caption{Một ví dụ ảnh trong bộ dữ liệu WIDER FACE \cite{yang2016wider} (a) so sánh với bộ dữ liệu WIDER FACE kích thước lớn dạng lưới $2 \times 2$ (b) và $3 \times 3$ (c)}
