\def\problems{
    ...
    Bài toán nhận diện đối tượng \index{nhận diện đối tượng} (object detection) là một bài toán rất phổ biến trong lĩnh vực thị giác máy tính và được coi là một trong số các bài toán máy học kinh điển.
    ...
    \noindent
    Bài toán nhận diện đối tượng \index{nhận diện đối tượng} là sự tổng hợp của hai bài toán con: bài toán định vị đối tượng (object localization) và bài toán phân loại ảnh (image classification).
    Cụ thể hơn, bài toán object localization là bài toán định vị vị trí của object trong ảnh bằng các bounding box \index{bounding box} đại diện cho vị trí của từng đối tượng.
