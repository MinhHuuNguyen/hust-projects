\def\widerface{
    ...
    - Độ khó 5 (khó nhất): Chỉ có thể phân biệt được với background \index{background} của ảnh. Với các bounding box \index{bounding box} ở mức độ khó này, nhóm tác giả không gán 5 điểm landmarks. \\
    ...
    Tuy nhiên, cho đến nay, kích thước như ảnh trong bộ WIDER FACE khoảng 1000 - 1500 pixels \index{pixels} không còn là kích thước lớn nữa.
