\def\sniper{
    ...
    \subsubsection*{Ý tưởng của phương pháp chuẩn bị dữ liệu SNIPER \index{SNIPER}}
    ...
    \subsubsection*{Định nghĩa Chip và phương pháp sinh ra Chip bằng phương pháp chuẩn bị dữ liệu SNIPER \index{SNIPER}}
    ...
    \subsubsection*{Phương pháp lựa chọn các positive Chips}
    ...
    Từ nhận xét trên, nhóm tác giả đề xuất việc sử dụng các khu vực được đề xuất từ mô hình RPN của Faster R-CNN bởi vì các khu vực này có khả năng khiến cho mô hình nhầm lẫn giữa đối tượng cụ thể nào đó và background \index{background}.
    ...
    \subsubsection*{Kết quả của phương pháp chuẩn bị dữ liệu SNIPER \index{SNIPER}}
    ...
    \subsubsection*{Vấn đề tồn đọng của phương pháp chuẩn bị dữ liệu SNIPER \index{SNIPER}}
