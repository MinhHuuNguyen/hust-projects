\def\objectdetectionhighres{
    ...
    Sau đó, ta bàn luận về một số phương pháp chuẩn bị dữ liệu tiêu biểu thuộc nhóm 2 qua các \textbf{\textit{phần 3.2. Phương pháp chuẩn bị dữ liệu SNIP, phần 3.3. Phương pháp chuẩn bị dữ liệu SNIPER \index{SNIPER}}}.
    Cuối cùng, ta sẽ thảo luận về một mô hình khá hoàn thiện để xử lý ảnh chất lượng cao qua \textbf{\textit{phần 3.4. Mô hình AutoFocus \index{AutoFocus}}}.
    ...
    \subsection{Mô hình AutoFocus \index{AutoFocus}}
