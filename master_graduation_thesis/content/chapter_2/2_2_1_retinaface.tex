\def\retinaface{
    ...
    RetinaFace cũng sử dụng kiến trúc backbone Feature Pyramid Network nhằm trích xuất đặc trưng của ảnh đầu vào với nhiều kích thước feature maps \index{feature maps} khác nhau.
