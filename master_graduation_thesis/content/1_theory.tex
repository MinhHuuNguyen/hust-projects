\def\objectdetection{
    ...
    \noindent
    Trong khuôn khổ nghiên cứu của luận văn, đối với các mô hình two-stage, ta sẽ cùng bàn luận về một số mô hình tiêu biểu trong \textbf{\textit{phần 2.1. Nhóm các mô hình R-CNN, Fast R-CNN và Faster R-CNN}} và \textbf{\textit{phần 2.2. Kiến trúc Feature Pyramid Networks}}, còn đối với các mô hình single-stage, ta sẽ bàn luận trong \textbf{\textit{phần 2.3. Mô hình RetinaNet}}.
