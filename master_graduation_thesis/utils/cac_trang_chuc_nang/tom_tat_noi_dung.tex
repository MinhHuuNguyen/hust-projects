...
\def \tomtatnoidung{
    ...
    Trong khuôn khổ của luận văn, tôi sẽ nghiên cứu về các mô hình học sâu đã có sẵn giải quyết bài toán nhận diện đối tượng \index{nhận diện đối tượng} và nhận diện khuôn mặt cũng như đề xuất mô hình mới - có tên là RetinaFocus giúp giải quyết bài toán với ảnh chất lượng cao.
