\def\cacbaitoan{
    ...
    Chi tiết về một số nghiên cứu giải bài toán object detection sẽ được thảo luận kỹ hơn trong phần \textit{2. Các mô hình giải quyết bài toán object detection}.
