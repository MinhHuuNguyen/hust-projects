...
\begin{document}
    ...
    \newpage
    \input{utils/cac_trang_chuc_nang/de_tai_luan_van.tex}
    \detailuanvan
    ...
    \newpage
    \input{content/1_problems.tex}
    \problems

    \newpage
    \input{content/2_object_detection.tex}
    \objectdetection

    \newpage
    \input{content/3_object_detection_high_res.tex}
    \objectdetectionhighres

    \newpage
    \input{content/4_face_detection.tex}
    \facedetection

    \newpage
    \input{content/5_retinafocus.tex}
    \retinafocus
    ...
    % Phan nay in rieng, khong in chung trong quyen luan van
    \newpage
    \input{utils/tom_tat_luan_van_rieng.tex}
    \tomtatluanvanrieng
